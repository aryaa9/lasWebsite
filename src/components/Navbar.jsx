  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      ...
      <ul className='hidden md:flex'>
        ...
        <li className='p-4'><a href="#events">Events</a></li>
        <li className='p-4'><a href="#team">Meet the Team</a></li>
      </ul>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
        ...
        <li className='p-4 border-b border-gray-600'><a href="#events">Events</a></li>
        <li className='p-4 border-b border-gray-600'><a href="#team">Meet The Team</a></li>
      </ul>
    </div>
  );
};
